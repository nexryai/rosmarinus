...
| `POST` | `/api/v1/actors/{actorId}/media` | Reserve media metadata and obtain a signed object-storage PUT URL |
| `POST` | `/api/v1/actors/{actorId}/media/{mediaId}/complete` | Verify the uploaded object and mark the media ready |
| `DELETE` | `/api/v1/actors/{actorId}/media/{mediaId}` | Delete an Actor-owned object and its metadata |
