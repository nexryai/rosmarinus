...
import (
	...
	"github.com/nexryai/rosmarinus/internal/emojiadmin"
...
func New(ctx context.Context, cfg config.Config, logger *log.Logger) (*App, error) {
	...
	webFingerClient, _ := mediafetch.NewSafeHTTPClient(cfg.InstanceMetadataTimeout, cfg.UserAgent, cfg.MediaAllowedPrivateNetworks)
	apWorker.SetWebFingerResolver(cache.NewCachedWebFinger(apwebfinger.New(webFingerClient, cfg.UserAgent), valueCache))
